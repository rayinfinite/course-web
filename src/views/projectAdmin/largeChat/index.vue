    ...
    <div class="container">
      <div
        ...
        <div class="content">
          ...
          <!-- <a @click="onRouter('/projectAdmin/system/roleList')">查看详情</a> -->
        </div>
      </div>
      <div
        ref="cardTwo"
        ...
        <div class="content">
          ...
          <a @click="onRouter('/projectAdmin/projectModule/projectManage')">查看详情</a>
        </div>
      </div>
      <div
        ref="cardThree"
        ...
        <div class="content">
          ...
          <a @click="onRouter('/projectAdmin/moneyModule/moneyManage')">查看详情</a>
        </div>
      </div>
      <div
        ref="cardfour"
        ...
        <div class="content">
          ...
          <a @click="onRouter('/projectAdmin/approvalModule/projectProcess')">查看详情</a>
        </div>
      </div>
    </div>
  </div>
